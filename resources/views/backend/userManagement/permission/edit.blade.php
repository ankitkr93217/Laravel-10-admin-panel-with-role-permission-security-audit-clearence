              ...
              <div class="row g-3">
               ...
               <div class="col-lg-3">
                <div class="form-group">
                 ...
                 <div class="form-control-wrap">
                  <input type="text" class="form-control" Placeholder="Name" value="{{ $permission->name }}"   name="name"   >
                  <p id="numberText"></p>
                 </div>
                </div>
               </div>
               ...
               <div class="col-lg-3">
                <div class="form-group">
                 ...
                 <div class="form-control-wrap">
                  <input type="text" class="form-control" Placeholder="Display Name" value="{{ $permission->display_name }}"   name="display_name"   >
                  <p id="numberText"></p>
                 </div>
                </div>
               </div>
               <div class="col-lg-3">
                <div class="form-group">
                 ...
                 <div class="form-control-wrap">
                  <input type="text" class="form-control" Placeholder="Group Name" value="{{ $permission->group_name }}"   name="group_name"   >
                  <p id="numberText"></p>
                 </div>
                </div>
               </div>
